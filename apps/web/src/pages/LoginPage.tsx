...
export function LoginPage() {
    const { user, signInWithGitHub, loading } = useAuthStore();
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-12">
                        <div className="flex items-center space-x-1">
                            <img src={logoDark} alt="HashTribe" className="h-24" />
                            <span className="text-white text-4xl font-bold">HashTribe</span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full bg-white hover:bg-grey-100 text-black font-semibold py-3.5 px-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-3 mb-6 hover:shadow-glow disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {loading ? (
                            <>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-black text-grey-500">or sign in with email</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <label className="flex items-center">
                            <input type="checkbox" className="w-4 h-4 rounded border-grey-700 bg-charcoal-900" disabled />
                            <span className="ml-2 text-sm text-grey-400">Remember me?</span>
                        </label>
                    ...
                    <button
                        disabled
                        className="w-full bg-grey-800 text-grey-500 font-semibold py-3.5 px-4 rounded-lg mb-6 cursor-not-allowed"
                    >
                        Login
                    </button>
                    ...
                    <p className="text-center text-sm text-grey-500">
                        Not registered yet?{' '}
                        <a href="#" className="text-white hover:text-grey-200 transition-colors">
                            Create an account
                        </a>
                    </p>
